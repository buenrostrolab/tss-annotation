...
awk '{print substr($0,4)}' ../TSS/hg19.refGene.TSS.bed | awk '{print "human"$0}' > ../TSS/hg19-mm10.refGene.TSS.bed
awk '{print substr($0,4)}' ../TSS/mm10.refGene.TSS.bed | awk '{print "mouse"$0}' >> ../TSS/hg19-mm10.refGene.TSS.bed
